...
# read run info 
# ================ =============
target,beamEnergy,hsec,thetac,prescale,bmcur1,bmcur2,bcm1charge,bcm2charge,cltime,eltime,trackeff,trigeff,rate = np.loadtxt("/w/hallc-scifs17exp/xem2/abishek/monte-carlo/mc-reweight/input/recon-mc/carbon_5p1_recon.in")

#print (thetac)
#if target != 11 or target != 15:
    #cryo = False
...
#===================  =====================
#     laoding output file from rc-extrnal #                                 
#===================  =====================
...
#================   ============================================
# calculate radiative correction by doing linear interpolation #
#================    ===========================================
xt = R.TGraph2D()
rt = R.TGraph2D()
...
#print (xt.Interpolate(14.51, 16.002))
